...
We define the file names and grouping manually here. In a production pipeline,
...
# Load the Lab 2 mzML files directly from MassIVE.
# MsBackendMassIVE downloads and caches the files locally via BiocFileCache;
