...
#' - filter the data by retention time
...
completely overlapping chromatographic peak, if the intensity below both apexes
is lower than a certain proportion of the apex intensity of the lower intensity
peak.
...
With a `bw = 7` a single feature was defined.

We use these parameter now for the initial correspondence analysis on the full
data set.
